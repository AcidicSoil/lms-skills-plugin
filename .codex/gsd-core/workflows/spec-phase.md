...
ones). Reference: @/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/user/projects/lms-skills-plugin/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/user/projects/lms-skills-plugin/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/user/projects/lms-skills-plugin/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/user/projects/lms-skills-plugin/.codex/gsd-core/templates/spec.md.
