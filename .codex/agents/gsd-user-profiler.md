...
<reference>
@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/user-profiling.md` to load:
