...
<required_reading>
@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/user-story-template.md
@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/spidr-splitting.md
@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/spidr-splitting.md`. Briefly:
