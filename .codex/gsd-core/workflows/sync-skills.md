...
INSTALL_JS_GLOBAL="/home/user/projects/lms-skills-plugin/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/projects/lms-skills-plugin/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
