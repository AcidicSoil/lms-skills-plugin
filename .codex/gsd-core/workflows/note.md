...
- **Global scope**: `/home/user/projects/lms-skills-plugin/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/user/projects/lms-skills-plugin/.codex/notes/`)
...
2. Glob `/home/user/projects/lms-skills-plugin/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/user/projects/lms-skills-plugin/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/user/projects/lms-skills-plugin/.codex/notes/` — works in any directory
