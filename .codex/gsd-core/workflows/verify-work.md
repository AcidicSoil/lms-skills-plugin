...
<template>
@/home/user/projects/lms-skills-plugin/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/user/projects/lms-skills-plugin/.codex/gsd-core/workflows/transition.md`.
...
- Follow @/home/user/projects/lms-skills-plugin/.codex/gsd-core/workflows/diagnose-issues.md
