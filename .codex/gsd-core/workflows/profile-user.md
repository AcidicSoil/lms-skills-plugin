...
Key references:
- @/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/ui-brand.md (display patterns)
- @/home/user/projects/lms-skills-plugin/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/user/projects/lms-skills-plugin/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/user/projects/lms-skills-plugin/.codex/gsd-core/USER-PROFILE.md" "/home/user/projects/lms-skills-plugin/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/user/projects/lms-skills-plugin/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/user-profiling.md`
...
Reference: @/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/user/projects/lms-skills-plugin/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/user/projects/lms-skills-plugin/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/user/projects/lms-skills-plugin/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at /home/user/projects/lms-skills-plugin/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/user/projects/lms-skills-plugin/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/home/user/projects/lms-skills-plugin/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /home/user/projects/lms-skills-plugin/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /home/user/projects/lms-skills-plugin/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.codex/AGENTS.md>
  ✓ Global AGENTS.md        /home/user/projects/lms-skills-plugin/.codex/AGENTS.md
```
