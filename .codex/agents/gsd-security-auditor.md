...
**Verification depth scales with `asvs_level`** (see @/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
