...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/projects/lms-skills-plugin/.codex/.gsd-surface.json`
(sibling to `/home/user/projects/lms-skills-plugin/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/projects/lms-skills-plugin/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`/home/user/projects/lms-skills-plugin/.codex/skills`).
...
`/home/user/projects/lms-skills-plugin/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/projects/lms-skills-plugin/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/projects/lms-skills-plugin/.codex/.gsd-surface.json`
Install profile marker: `/home/user/projects/lms-skills-plugin/.codex/.gsd-profile`
Skill dirs: `/home/user/projects/lms-skills-plugin/.codex/skills/gsd-*/`
Engine module: `/home/user/projects/lms-skills-plugin/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/projects/lms-skills-plugin/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
