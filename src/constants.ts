...
export const TOOL_DEFAULT_TIMEOUT_MS = 15_000;
export const TOOL_LIST_SKILLS_TIMEOUT_MS = 20_000;
export const TOOL_READ_SKILL_FILE_TIMEOUT_MS = 10_000;
export const TOOL_LIST_SKILL_FILES_TIMEOUT_MS = 15_000;
export const TOOL_COMMAND_SETUP_TIMEOUT_MS = 5_000;
