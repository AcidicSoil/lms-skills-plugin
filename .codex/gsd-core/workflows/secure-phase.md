...
```
Agent(
  prompt="Read /home/user/projects/lms-skills-plugin/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/projects/lms-skills-plugin/.codex/gsd-core/templates/SECURITY.md`
