...
<required_reading>
@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/ai-frameworks.md
@/home/user/projects/lms-skills-plugin/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/user/projects/lms-skills-plugin/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/user/projects/lms-skills-plugin/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/user/projects/lms-skills-plugin/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/user/projects/lms-skills-plugin/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/user/projects/lms-skills-plugin/.codex/agents/gsd-eval-planner.md for instructions.
